...
import (
	...
	"github.com/shivsondhi/ttt/x/ttt"
	tttkeeper "github.com/shivsondhi/ttt/x/ttt/keeper"
	ttttypes "github.com/shivsondhi/ttt/x/ttt/types"
...
var (
	...
	DefaultNodeHome = os.ExpandEnv("$HOME/.tttd")
...
func NewInitApp(
	...
	app.tttKeeper = tttkeeper.NewKeeper(
		app.bankKeeper,
		app.cdc,
		keys[ttttypes.StoreKey],
		app.accountKeeper,
	)
	...
	app.mm = module.NewManager(
		...
		ttt.NewAppModule(app.tttKeeper, app.bankKeeper),
