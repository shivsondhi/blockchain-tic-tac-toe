...
// Keeper of the ttt store
type Keeper struct {
	CoinKeeper bank.Keeper
	storeKey   sdk.StoreKey
	cdc        *codec.Codec
	AccKeeper types.AuthKeeper
	// paramspace types.ParamSubspace
}

// NewKeeper creates a ttt keeper
func NewKeeper(coinKeeper bank.Keeper, cdc *codec.Codec, key sdk.StoreKey, authKeeper types.AuthKeeper) Keeper {
	keeper := Keeper{
